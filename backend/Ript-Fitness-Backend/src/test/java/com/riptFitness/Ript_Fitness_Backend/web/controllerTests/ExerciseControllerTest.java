...
public class ExerciseControllerTest {
    ...
    public void testAddExercise() throws Exception {
        ...
        mockMvc.perform(post("/exercises/addExercise")
    ...
    public void testDeleteExercise() throws Exception {
        ...
        mockMvc.perform(delete("/exercises/deleteExercise/1"))
    ...
    public void testUpdateReps() throws Exception {
        ...
        mockMvc.perform(put("/exercises/editReps/1/1/15"))
    ...
    public void testUpdateSets() throws Exception {
        ...
        mockMvc.perform(put("/exercises/editSets/1/3"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.nameOfExercise").value("Push Ups"));
    }
    ...
    public void testEditExerciseName() throws Exception {
        ...
        mockMvc.perform(put("/exercises/editExerciseName/1/Pull Ups"))
                .andExpect(status().isOk())
    ...
    public void testFindByKeyword() throws Exception {
        List<String> similarExercises = Arrays.asList("Push Ups", "Pull Ups");
        when(exerciseService.findByKeyword("ups")).thenReturn(similarExercises);

        mockMvc.perform(get("/exercises/findByKeyword/ups"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0]").value("Push Ups"))
                .andExpect(jsonPath("$[1]").value("Pull Ups"));
    }
}
