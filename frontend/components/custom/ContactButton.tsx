...
//import { contactsList } from '../screens/AllContacts';
...
const handleFontSize = (event) => {
    ...
    return (
        ...
        <TouchableOpacity
            ...
            onPress={() => props.navigation.navigate(editContactScreen)}
            style={[styles.tile, styles.where]}>
                ...
                <View /*onLayout={setDimensions}*/ style={[styles.profileInfoView]} >
                    <Text /*fontSizeIndex={0} onTextLayout={handleFontSize}*/ style={[styles.line1, {fontSize:fontSizes[0]}]}>{name}</Text>
                    <Text /*fontSizeIndex={1} onTextLayout={handleFontSize}*/ style={[styles.line2, { fontSize:fontSizes[1] }]}>{title}</Text>
                    <Text /*fontSizeIndex={2}*/  style={[styles.line3, {fontSize:fontSizes[2]}]}>{employer}</Text>        
                </View>
